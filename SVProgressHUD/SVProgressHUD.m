...
#else
#if TARGET_OS_VISION
    CGRect frame = CGRectMake(0, 0, 1920, 1080);
#else
...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        NSURL *url = nil;
#if SVProgressHUD_SPM
        // Use resource bundle generated by SPM
        url = [bundle URLForResource:@"SVProgressHUD_SVProgressHUD" withExtension:@"bundle"];
#else
        url = [bundle URLForResource:@"SVProgressHUD" withExtension:@"bundle"];
#endif /* SVProgressHUD_SPM */
        if (!url) {
            // No resource bundle
            return;
        }
